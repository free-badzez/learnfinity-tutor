...
const Hero = () => {
  ...
  return <div ref={heroRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-16">
      {/* Background gradient */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-screen flex items-center">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-on-load opacity-0 transform translate-y-4 transition-all duration-500" style={{
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-lg animate-on-load opacity-0 transform translate-y-4 transition-all duration-500" style={{
            transitionDelay: '300ms'
          }}>
              Experience adaptive learning that adjusts to your pace and style, with real-time feedback and personalized guidance.
            </p>
            
            <div className="flex flex-wrap gap-4 animate-on-load opacity-0 transform translate-y-4 transition-all duration-500" style={{
          ...
          <div className="lg:w-1/2 animate-on-load opacity-0 transform translate-y-4 transition-all duration-500" style={{
